...
fserver = ServerProxy("http://localhost:10006")
...
print("Updating ... ", end="")
print(fserver.update_forecast("master-of-weather", "2012-11-05", "rains dogs and cats", 10.3, 3.0))
print(fserver.update_forecast("heslo", "2012-11-05", "padaji kocky", 10.3, 3.0))
